...
public class Cuenta {
    ...
    public void setSaldo(double saldo) throws CuentaException{        if (saldo < -100){
    ...
    public void ingresar(double dinero) throws CuentaException{
        if (dinero < 0) {
            throw new CuentaException("No se puede ingresar dinero negativo. La operación fue cancelada.");
        } else {
        this.saldo += dinero;
        }
    }
